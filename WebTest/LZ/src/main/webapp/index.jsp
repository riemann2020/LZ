    ...
    <table border="1">
        ...
        <tr>
            ...
            <td>
                <ol>
                    ...
                    <li>
                        <a
                            href="https://blog.csdn.net/weixin_41948075/article/details/89422795?depth_1-utm_source=distribute.pc_relevant.none-task&utm_source=distribute.pc_relevant.none-task">
                    ...
                    <li>
                        <a
                            href="https://blog.csdn.net/weixin_38481963/article/details/82875720?depth_1-utm_source=distribute.pc_relevant.none-task&utm_source=distribute.pc_relevant.none-task">
                            <span>用Eclipse开始第1个Web项目</span>
                        </a>
                    </li>
                    <li>
                        <a
                            href="https://www.myeclipsecn.com/learningcenter/web-development/myeclipse-web-project-tutorial/">
                            <span>用MyEclipse开始第1个Web项目</span>
                        </a>
                    </li>
                    <li>
                        <a
                            href="https://blog.csdn.net/cshichao/article/details/9664969?depth_1-utm_source=distribute.pc_relevant.none-task&utm_source=distribute.pc_relevant.none-task">
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li><a
                            href="http://mooc1.xueyinonline.com/nodedetailcontroller/visitnodedetail?courseId=206842782&knowledgeId=208772164">学银在线：Servlet教程</a>
                    </li>
        ...
        <tr>
            ...
            <td>
                <ol>
                    <li><a
                            href="http://mooc1.xueyinonline.com/nodedetailcontroller/visitnodedetail?courseId=206842782&knowledgeId=208772117">学银在线：JSP教程</a>
                    </li>
        ...
        <tr>
            ...
            <td>
                <ol>
                    ...
                    <li><a
                            href="http://2992f329v4.wicp.vip/ServletDemo/index.jsp">网页示例：Servlet与JSP之间数据传输（使用了MySQL数据库）</a>
                    </li>
                </ol>
            </td>
        </tr>
